...
Project kickoff. Stakeholders around the table. Someone asks about the timeline.
...
*Building a government platform and need accessibility baked in from the start? [Let's talk](mailto:contact@varunbaker.com).*
